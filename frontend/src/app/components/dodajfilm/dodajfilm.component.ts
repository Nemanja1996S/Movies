...
@Component({
  selector: 'app-dodajfilm',
  templateUrl: './dodajfilm.component.html',
  styleUrls: ['./dodajfilm.component.css']
})
export class DodajfilmComponent implements OnInit {
  ...
  constructor(private movie: MovieService, private admin: AdminService, private ruter: Router, private snackbar: MatSnackBar) { }
  ...
  ngOnInit(): void {
    ...
    this.form = new FormGroup({
      ...
      reziser: new FormControl(null, { validators: [Validators.required]}),
    ...
    this.image = "assets/generic_movie.jpg";
  ...
  dodaj() {
    ...
    this.movie.dodaj_film(
      this.form.value.slika,
      this.form.value.naziv,
      this.form.value.reziser,
